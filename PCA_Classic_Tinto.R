...
data_standard.cpca$rotation

#Escrever os nosso dados dos vinhos mas agora em vez das 11 features temos 5 PC's
y <- data_standard.cpca$x[,1:5]
...
cat("Accuracy Naive Bayes PCA Classica Red wine =" , cmx$overall[1])
...
cmx <- confusionMatrix(naive_pred, test_cl$Quality)
cat("Accuracy Naive Bayes Red Wine Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy Naive Bayes PCA Classica Red wine Output 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy SVM PCA Classica Red wine =" , cmx$overall[1])
...
cat("Accuracy SVM PCA Classica Red wine Considerando Certo quando 2 Classes têm P >0.4 =" , cmx$overall[1])
...
cat("Accuracy SVM PCA Classica Red wine Output 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy LDA PCA Classica Red wine =" , cmx$overall[1])
...
cat("Accuracy LDA PCA Classica Red wine Output Classes 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy RF PCA Classica Red Wine =" , cmx$overall[1])
...
cmx <- confusionMatrix(rf_pred, test_cl$Quality)
cat("Accuracy RF Red Wine PCA Classica Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy RF PCA Classica Red wine Output Classes 0,1,2 =" , cmx$overall[1])
