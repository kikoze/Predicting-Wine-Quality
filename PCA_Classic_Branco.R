...
cmx <- confusionMatrix(naive_pred, test_cl$Quality)
cat("Accuracy Naive Bayes PCA Classica White Wine Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy SVM PCA Classica White Wine Considerando Certo quando 2 Classes têm P >0.4 =" , cmx$overall[1])
...
cmx <- confusionMatrix(lda_pred, test_cl$Quality)
cat("Accuracy LDA White Wine PCA Classica Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cmx <- confusionMatrix(rf_pred, test_cl$Quality)
cat("Accuracy RF White Wine PCA Classica Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
