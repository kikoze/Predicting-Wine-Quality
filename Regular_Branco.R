...
cat("Accuracy Naive Bayes Dados Normalizados White Wine =" , cmx$overall[1])
...
cmx <- confusionMatrix(naive_pred, test_cl$Quality)
cat("Accuracy Naive Bayes Dados Normalizados White Wine Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy Naive Bayes Dados Normalizados White Wine Output 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy SVM Dados Normalizados White Wine =" , cmx$overall[1])
...
cat("Accuracy SVM Dados Normalizados White Wine Considerando Certo quando 2 Classes têm P >0.4 =" , cmx$overall[1])
...
cat("Accuracy SVM Dados Normalizados White Wine Output 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy LDA Dados Normalizados White Wine =" , cmx$overall[1])
...
cmx <- confusionMatrix(lda_pred, test_cl$Quality)
cat("Accuracy LDA White Wine Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy LDA Dados Normalizados White Wine Output Classes 0,1,2 =" , cmx$overall[1])
...
cat("Accuracy RF Dados Normalizados White Wine =" , cmx$overall[1])
...
cmx <- confusionMatrix(rf_pred, test_cl$Quality)
cat("Accuracy RF White Wine Dados Normalizados Considerando Certo quando 2 Classes têm P >0.4 = =" , cmx$overall[1])
...
cat("Accuracy RF Dados Normalizados White Wine Output Classes 0,1,2 =" , cmx$overall[1])
